...
function App() {
  ...
  return (
    <div className='bg-pink-50 text-pink-900 scroll-smooth'>
      ...
      <section id='home' className='min-h-screen flex items-center px-6 bg-cover bg-no-repeat' style={{ backgroundImage: `url(${bg})`}}>
        ...
        <p className='mt-6 text-lg text-pink-700 text-center'> A passionate frontend developer who loves creating interactive web experiences</p>
             ...
             <div className="hidden md:flex absolute right-10 top-1/2 -translate-y-1/2 flex-col gap-6">
                ...
                <a href="https://ph.pinterest.com/janejavillo_/" target="_blank" rel="noopener noreferrer" className="text-3xl text-pink-500 hover:text-white hover:bg-pink-500 p-3 rounded-full shadow-lg hover:scale-125 transition duration-300"><FaPinterest/></a></div>  
        </div>
      </section>
      ...
      <section id='projects' className='min-h-screen flex flex-col justify-center items-center py-20 px-6 text-center bg-gradient-to-br from-pink-100 via-rose-200 to-pink-300'>
